                ...
                <Row gutter={16}>
                    <Col span={12}>
                        <Card bordered={false} className='card-item'>
                            ...
                            <Dropdown overlay={menu} trigger={['click']}><a>click me <Icon
                                type='down'/></a></Dropdown>&emsp;
                        </Card>
                        <Card bordered={false} className='card-item'>
                    ...
                    <Col span={12}>
                        <Card bordered={false} className='card-item'>
                            <Dropdown overlay={menu2}><a href="">Cascading menu <Icon
                                type="down"/></a></Dropdown>&emsp;&emsp;
                            <Dropdown overlay={menu2}><Button>Cascading menu <Icon type="down"/></Button></Dropdown>
                        </Card>
                        <Card bordered={false} className='card-item'>
                            <p>
                                <Dropdown overlay={menu}
                                          placement="bottomLeft"><Button>bottomLeft</Button></Dropdown>&emsp;
                                <Dropdown overlay={menu}
                                          placement="bottomCenter"><Button>bottomCenter</Button></Dropdown>&emsp;
                            ...
                            <div>
                                ...
                                <Dropdown overlay={menu}
                                          placement="topCenter"><Button>topCenter</Button></Dropdown>&emsp;
